...
class Api::V1::InvoiceItemsControllerTest < ActionController::TestCase
  test "#show" do
    ...
    assert_equal "5600.0", invoice_item[:unit_price]
  ...
  test "#find_all" do
    ...
    get :find_all, format: :json, unit_price: "587600.0"
    invoice_items = JSON.parse(response.body, symbolize_names: true)[:invoice_items]
    ...
    assert_equal "587600.0", invoice_item[:unit_price]
    assert_equal 113629430, invoice_item[:item_id]
    assert_equal 298486374, invoice_item[:invoice_id]
  end

  test "#random" do
    get :random, format: :json
    invoice_item = JSON.parse(response.body, symbolize_names: true)[:invoice_items]
